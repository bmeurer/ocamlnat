...
(* OASIS_START *)
(* DO NOT EDIT (digest: d9af254dd91983ec355cc188cb0d0dad) *)
(*
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Benedikt Meurer"; "Marcell Fischbach"];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "make"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "bytecomp";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "typing"];
                      bs_build_tools =
                        [ExternalTool "make"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "asmcomp";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "bytecomp"];
                      bs_build_tools =
                        [ExternalTool "make"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "asmcomp";
                           InternalLibrary "bytecomp";
